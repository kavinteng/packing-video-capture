...
if __name__ == '__main__':
    while True:
        ...
        if ip1 == '' and ip2 == '' and ip3 == '' and ip4 == '' and ip5 == '' and ip6 == '':
            ...
            check_but8 = testDeviceusb(source=1, positionx=1920, positiony=0)
            check_but9 = testDeviceusb(source=2, positionx=3840, positiony=0)
            ...
            if check_but8 == True:
                but8 = Button(root, text='USB-cam2', width=20, bg='#32CD32',fg='white', command=lambda
                    camID=1,
                    positionx=1920, positiony=0: run(None, None, camID, positionx, positiony))
                but8.pack(padx=5, pady=5)
            if check_but9 == True:
                but9 = Button(root, text='USB-cam3', width=20, bg='#32CD32',fg='white', command=lambda
                    camID=2,
                    positionx=3840, positiony=0: run(None, None, camID, positionx, positiony))
